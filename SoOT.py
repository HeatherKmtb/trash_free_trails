...
def EPR_materials(TFTin, dataout):
    ...
    plastic = ['Value Plastic energy gel sachet','Value Plastic energy gel end', 
            ...
            'Value Wrapper "corners" / tear-offs',
            'Value Crisps Packets','Value Plastic milk bottles',
            'Value Plastic food containers','Value Cleaning products containers','Value Plastic bottle, top', 'Value Plastic straws']
    
    fibre_composite = ['Value Hot drinks cups','Value Food on the go (eg.salad boxes)','Value Hot drinks tops and stirrers', 
